...
import { LifepassTableContent } from './lifepass-table-content'

/**
 * Server component wrapper for the lifepass table
 *
 * @description
 ...
 *
 * @returns Promise resolving to the lifepass table component with data
 */
export async function LifepassTableWrapper({
  resortName,
  searchParams,
}: {
