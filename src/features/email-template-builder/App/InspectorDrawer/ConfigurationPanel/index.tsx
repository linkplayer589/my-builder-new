...
import { ColumnsContainerProps } from "@/features/email-template-builder/@usewaypoint/block-columns-container"
...
import BottomSectionSidebarPanel from "./input-panels/BottomSidebarPanel"
import ButtonSidebarPanel from "./input-panels/ButtonSidebarPanel"
import CanvasContainerSidebarPanel from "./input-panels/CanvasContainerSidebarPanel"
    ...
    case "ColumnsContainer":
      return (
        <ColumnsContainerSidebarPanel
          key={selectedBlockId}
          data={data as ColumnsContainerProps}
          setData={(next) => setBlock({ type, data: next as any })}
        />
      )
    case "Container":
      return (
        <ContainerSidebarPanel
          key={selectedBlockId}
          data={data}
          setData={(data) => setBlock({ type, data: data as any })}
        />
      )
    case "Divider":
      return (
