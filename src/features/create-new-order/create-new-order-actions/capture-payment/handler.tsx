...
export type CapturePaymentSchemaType = {
  orderId: string
...
export async function capturePayment(
  payload: CapturePaymentSchemaType,
  signal?: AbortSignal
): Promise<
  | { success: true; data: CapturePaymentResponse }
  | {
      success: false
      error: string
...
> {
  ...
  try {
    const url = new URL(`${HONO_API_URL}/api/cash-desk/capture-payment`)
