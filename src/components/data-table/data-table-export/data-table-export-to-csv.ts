 ...
 * 
 * @description
 * Exports the current table data to a CSV file with options for filtering columns
 * and selecting specific rows.
 * 
 * @param table - The table instance to export
 * @param opts - Export options
 * @param opts.filename - The filename for the CSV file (default: "table")
 * @param opts.excludeColumns - The columns to exclude from export (default: [])
