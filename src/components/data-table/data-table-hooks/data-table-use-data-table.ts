 ...
 * Data Table Hook
 * 
 * Main hook for managing table state including pagination, sorting, filtering,
 * and column visibility with URL query string synchronization.
 */

"use client"

import * as React from "react"
import type { DataTableFilterField, ExtendedSortingState } from "@/types/index"
import {
  getCoreRowModel,
  getFacetedRowModel,
